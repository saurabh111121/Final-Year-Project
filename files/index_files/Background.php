...
<body>
	 <!--head background-->
	<div style="position:absolute;left:0%;top:0%; height:13.2%; width:100%; z-index:-1; background:#E7EBF2">   </div>
	<!--text: faceback -->
	<!--body background-->
    ...
    <div style="position:absolute;left:5%;top:105%;"><font face="myFbFont"> Developer: <span style=" color:#3B5998;" onMouseOver="open_developer_details()" onMouseOut="close_developer_details()" id="my_name">  Saurabh kala  </span> </font> </div>

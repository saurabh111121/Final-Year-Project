<?php
	...
	if(isset($_SESSION['user']))
	{
		...
		if(isset($_POST['feedback']))
		{
			...
			$star=$_POST['star'];
			$time=$_POST['feedback_time'];
			mysql_query("insert into feedback(user_id,feedback_txt,star,Date) values($userid,'$txt','$star','$time')");
		}
		
		if(isset($_POST['delete_feedback']))
		{
			$id=intval($_POST['feedback_id']);
			mysql_query("delete from feedback where feedback_id=$id");
		}
...
<body>
	...
	<div style="position:absolute; left:25.3%; top:32.5%;">
		<textarea style="height:100; width:450;" name="feedback_txt" maxlength="100" placeholder="What's on your mind?"></textarea>
	</div>	
...
<?php
	while($feedback_data=mysql_fetch_array($que_feedback))
	{
		...
		$txt=$feedback_data[2];
		$star=$feedback_data[3];
		$time=$feedback_data[4];
		$que_user_info=mysql_query("select * from users where user_id=$user_id");
		$user_data=mysql_fetch_array($que_user_info);
		$user_name=$user_data[1];
		$user_email=$user_data[2];
		$user_gender=$user_data[4];
		$que_user_pic=mysql_query("select * from user_profile_pic where user_id=$user_id");
...
?>
	...
	<tr>
    	<td style="padding-left:25;" rowspan="2"> <img src="../../users/<?php echo $user_gender; ?>/<?php echo $user_email; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55">  </td>
        <td colspan="2" style="padding:7;"> <a href="../view_profile/view_profile.php?id=<?php echo $user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:#003399;" onMouseOver="feedback_name_underLine(<?php echo $feedback_id; ?>)" onMouseOut="feedback_name_NounderLine(<?php echo $feedback_id; ?>)" id="uname<?php echo $feedback_id; ?>"> <?php echo $user_name; ?> </a>   </td>
       
    </tr>
    <tr>
		<td colspan="2" style=" padding-left:7; "><?php echo $txt; ?></td>
        <td> </td>
        <td> </td>
	</tr>
    <tr>
    	<td> </td>
        <td style=" padding-left:7;"> <span style="color:#999999;">  Give's <?php echo $star; ?> star </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#999999;"> <?php echo $time; ?> </span> </td>
        <td> </td>
    </tr>
